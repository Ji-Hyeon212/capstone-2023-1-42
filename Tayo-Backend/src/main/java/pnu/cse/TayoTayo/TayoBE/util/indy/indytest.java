package pnu.cse.TayoTayo.TayoBE.util.indy;
...
public class indytest {
    ...
    public static void setUp() throws Exception {
        ...
        System.out.println("\n\n\nSTEP5 - TayoTayo Service creates Transcript Credential Definition");
...
//        search_for_job_application_proof_request_forbob.close();
        ...
        // STEP7 - Alice makes verifiable presentation(VP) to Company 즉, VP(Verifiable Presentation) 생성
            ...
            String proofJson = Anoncreds.proverCreateProof(
                    AliceWallet
                    ,Alice.get("job_application_proof_request").toString()
